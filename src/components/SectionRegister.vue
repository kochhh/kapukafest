    ...
    <div class="container">
      <div class="max-w-lg">
        ...
        <form @submit.prevent="sendEmail">
          ...
          <div class="mt-6">
            <button type="submit" class="btn btn-iconic btn-green" :disabled="isLoading">
              <span>Надіслати</span>
            ...
            <div class="alert alert-success mt-4" v-if="isSent">
              <div class="alert-inner">
                <CheckCircleIcon class="h-8 w-8" />
                <div>
                  <h3>Дякуємо за реєстрацію!</h3>
                  <p>Незабаром ми зв'яжемося з&nbsp;вами для&nbsp;уточнення деталей.</p>
                </div>
              </div>
            </div>
            <div class="alert alert-error mt-4" v-if="isError">
              <div class="alert-inner">
                <ExclamationCircleIcon class="h-8 w-8" />
                <div>
                  <p>Виникла помилка. Спробуйте оновити сторінку або&nbsp;зайдіть пізніше.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="mt-12">
          ...
          <div class="flex flex-col items-start sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            <a href="https://t.me/kapuka_mmc" target="_blank" rel="nofollow noopener" class="btn btn-iconic btn-telegram">
            ...
            <a href="viber://chat?number=380634025924" target="_blank" rel="nofollow noopener" class="btn btn-iconic btn-viber">
            ...
            <a href="https://m.me/aleksandr.kapuka" target="_blank" rel="nofollow noopener" class="btn btn-iconic btn-messenger">
